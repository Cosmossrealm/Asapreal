...
module.exports = {
  ...
  alivepic: process.env.ALIVE_IMG || 'https://i.imgur.com/Mk20IJH.jpg',
  alivemsj: process.env.ALIVE_MSJ || '*BYE ASAP ,
  ...
  LANG: process.env.THEME|| 'ASAP-MD',
